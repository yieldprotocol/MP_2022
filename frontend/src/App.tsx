...
function App() {
  ...
  const [signer] = useContext(SignerContext); // eslint-disable-line @typescript-eslint/no-unused-vars
              ...
              <div className="section">
                ...
                <li>
                  <div>
                    <div>
                      <p>
                        {" "}
                        Create a new React component to show the account name
                        and ETH balance of the connected wallet.{" "}
                      </p>
                    </div>
                    <div
                      style={{
                ...
                <li>
                  <p>
                    Make this
                    <button
                      onClick={() => console.log("Make this button sends eth ")}
                    >
                      {" "}
                      Button{" "}
                    </button>
                    send <strong>1.25 </strong> Eth (or a variable amount) from
                    your connected account to another address: <input />.
                  </p>
                  <p style={{ fontSize: "14px" }}>
                  ...
                  <p style={{ fontSize: "14px" }}>
                    HINT: all the account info/functions you need for these
                    first two tasks are in the <em>signerContext </em>( It might
                    also be easier to break each task out into a new component).
                  </p>
                </li>
              </div>
